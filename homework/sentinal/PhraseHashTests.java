...
public class PhraseHashTests {
    ...
    public void testPut() {
        ...
        p.put("good job");
        p.put("great work");
        p.put("terrible advise");
        p.put("horrific event");

        p.put("good job bad advise");
        p.put("great work awful week");
        p.put("great work awful week");
        p.put("great word awful week");
        p.put("terrible advise amazing help");
        p.put("terrible advise amazing help");
        p.put("horrific event amazing hands");
        p.put("horrific event amazing hands");
    }
